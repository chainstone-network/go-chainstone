...
The crypto is documented at https://github.com/chainstone-network/wiki/wiki/Web3-Secret-Storage-Definition
	...
	if !ks.skipKeyFileVerification {
		...
		if err != nil {
			msg := "An error was encountered when saving and verifying the keystore file. \n" +
				...
				"https://github.com/chainstone-network/go-chainstone/issues." +
				"The error was : %s"
