...
type Config struct {
	...
	Client   *rpc.Client         // RPC client to execute Chainstoneeum requests through
...
// Welcome show summary of current Gchain instance and some metadata about the
// console's available modules.
func (c *Console) Welcome() {
	message := "Welcome to the Gchain JavaScript console!\n\n"

	// Print some generic Gchain metadata
