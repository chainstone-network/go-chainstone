...
func newTester(t *testing.T, confOverride func(*ethconfig.Config)) *tester {
	...
	// Create a networkless protocol stack and start an Chainstoneeum service within
	...
	ethConf := &ethconfig.Config{
		...
		Miner: miner.Config{
			Chainstonebase: common.HexToAddress(testAddress),
		},
	...
	if err != nil {
		t.Fatalf("failed to register Chainstoneeum protocol: %v", err)
	}
