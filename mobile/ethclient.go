...
// Contains a wrapper for the Chainstoneeum client.
...
type ChainstoneeumClient struct {
	client *ethclient.Client
}

// NewChainstoneeumClient connects a client to the given URL.
func NewChainstoneeumClient(rawurl string) (client *ChainstoneeumClient, _ error) {
	rawClient, err := ethclient.Dial(rawurl)
	return &ChainstoneeumClient{rawClient}, err
}

// GetBlockByHash returns the given full block.
func (ec *ChainstoneeumClient) GetBlockByHash(ctx *Context, hash *Hash) (block *Block, _ error) {
...
func (ec *ChainstoneeumClient) GetBlockByNumber(ctx *Context, number int64) (block *Block, _ error) {
	if number < 0 {
...
func (ec *ChainstoneeumClient) GetHeaderByHash(ctx *Context, hash *Hash) (header *Header, _ error) {
...
func (ec *ChainstoneeumClient) GetHeaderByNumber(ctx *Context, number int64) (header *Header, _ error) {
	if number < 0 {
...
func (ec *ChainstoneeumClient) GetTransactionByHash(ctx *Context, hash *Hash) (tx *Transaction, _ error) {
...
func (ec *ChainstoneeumClient) GetTransactionSender(ctx *Context, tx *Transaction, blockhash *Hash, index int) (sender *Address, _ error) {
...
func (ec *ChainstoneeumClient) GetTransactionCount(ctx *Context, hash *Hash) (count int, _ error) {
...
func (ec *ChainstoneeumClient) GetTransactionInBlock(ctx *Context, hash *Hash, index int) (tx *Transaction, _ error) {
...
func (ec *ChainstoneeumClient) GetTransactionReceipt(ctx *Context, hash *Hash) (receipt *Receipt, _ error) {
...
func (ec *ChainstoneeumClient) SyncProgress(ctx *Context) (progress *SyncProgress, _ error) {
...
func (ec *ChainstoneeumClient) SubscribeNewHead(ctx *Context, handler NewHeadHandler, buffer int) (sub *Subscription, _ error) {
...
func (ec *ChainstoneeumClient) GetBalanceAt(ctx *Context, account *Address, number int64) (balance *BigInt, _ error) {
	if number < 0 {
...
func (ec *ChainstoneeumClient) GetStorageAt(ctx *Context, account *Address, key *Hash, number int64) (storage []byte, _ error) {
	if number < 0 {
...
func (ec *ChainstoneeumClient) GetCodeAt(ctx *Context, account *Address, number int64) (code []byte, _ error) {
	if number < 0 {
...
func (ec *ChainstoneeumClient) GetNonceAt(ctx *Context, account *Address, number int64) (nonce int64, _ error) {
	if number < 0 {
...
func (ec *ChainstoneeumClient) FilterLogs(ctx *Context, query *FilterQuery) (logs *Logs, _ error) {
...
func (ec *ChainstoneeumClient) SubscribeFilterLogs(ctx *Context, query *FilterQuery, handler FilterLogsHandler, buffer int) (sub *Subscription, _ error) {
	// Subscribe to the event internally
...
func (ec *ChainstoneeumClient) GetPendingBalanceAt(ctx *Context, account *Address) (balance *BigInt, _ error) {
...
func (ec *ChainstoneeumClient) GetPendingStorageAt(ctx *Context, account *Address, key *Hash) (storage []byte, _ error) {
...
func (ec *ChainstoneeumClient) GetPendingCodeAt(ctx *Context, account *Address) (code []byte, _ error) {
...
func (ec *ChainstoneeumClient) GetPendingNonceAt(ctx *Context, account *Address) (nonce int64, _ error) {
...
func (ec *ChainstoneeumClient) GetPendingTransactionCount(ctx *Context) (count int, _ error) {
...
func (ec *ChainstoneeumClient) CallContract(ctx *Context, msg *CallMsg, number int64) (output []byte, _ error) {
	if number < 0 {
...
func (ec *ChainstoneeumClient) PendingCallContract(ctx *Context, msg *CallMsg) (output []byte, _ error) {
	return ec.client.PendingCallContract(ctx.context, msg.msg)
}

// SuggestGasPrice retrieves the currently suggested gas price to allow a timely
// execution of a transaction.
func (ec *ChainstoneeumClient) SuggestGasPrice(ctx *Context) (price *BigInt, _ error) {
...
func (ec *ChainstoneeumClient) EstimateGas(ctx *Context, msg *CallMsg) (gas int64, _ error) {
...
func (ec *ChainstoneeumClient) SendTransaction(ctx *Context, tx *Transaction) error {
