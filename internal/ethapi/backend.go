...
// Package ethapi implements the general Chainstoneeum API functions.
package ethapi
...
type Backend interface {
	// General Chainstoneeum API
	SyncProgress() chainstone.SyncProgress
...
func GetAPIs(apiBackend Backend) []rpc.API {
	...
	return []rpc.API{
		{
			Namespace: "eth",
			Service:   NewChainstoneeumAPI(apiBackend),
		}, {
			Namespace: "eth",
			...
			Namespace: "eth",
			Service:   NewChainstoneeumAccountAPI(apiBackend.AccountManager()),
		}, {
			Namespace: "personal",
