...
// Package types contains data types related to Chainstoneeum consensus.
package types
...
// Header represents a block header in the Chainstoneeum blockchain.
type Header struct {
...
// Block represents an entire block in the Chainstoneeum blockchain.
type Block struct {
	header       *Header
	uncles       []*Header
...
// DecodeRLP decodes the Chainstoneeum
...
// EncodeRLP serializes b into the Chainstoneeum RLP block format.
