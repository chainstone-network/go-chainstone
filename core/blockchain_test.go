...
//
// https://github.com/chainstone-network/go-chainstone/pull/15941
...
//
// Details at:
//   - https://github.com/chainstone-network/go-chainstone/issues/18977
//   - https://github.com/chainstone-network/go-chainstone/pull/18988
...
//     with 0.001 chainstone (thus created but no code)
...
func TestEIP1559Transition(t *testing.T) {
	var (
		...
		addr1   = crypto.PubkeyToAddress(key1.PublicKey)
		addr2   = crypto.PubkeyToAddress(key2.PublicKey)
		funds   = new(big.Int).Mul(common.Big1, big.NewInt(params.Chainstone))
		gspec   = &Genesis{
