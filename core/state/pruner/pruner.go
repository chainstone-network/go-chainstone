...
pruning. Remember don't start the Gchain without deleting the clean trie cache
otherwise the entire database may be damaged!

Check the command description "gchain snapshot prune-state --help" for more details.
`
