...
// Package forkid implements EIP-2124 (https://eips.chainstone.org/EIPS/eip-2124).
package forkid
...
// NewID calculates the Chainstoneeum fork ID from the chain config, genesis hash, and head.
...
// NewIDWithChain calculates the Chainstoneeum fork ID from an existing chain instance.
