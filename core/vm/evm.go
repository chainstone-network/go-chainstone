...
type BlockContext struct {
	...
	// sufficient chainstone to transfer the value
	CanTransfer CanTransferFunc
	// Transfer transfers chainstone from one account to the other
...
// EVM is the Chainstoneeum Virtual Machine base object and provides
...
type EVM struct {
	...
	// evm.
	Config Config
	// global (to this context) chainstone virtual machine
...
func (evm *EVM) CallCode(caller ContractRef, addr common.Address, input []byte, gas uint64, value *big.Int) (ret []byte, leftOverGas uint64, err error) {
	...
	// Fail if we're trying to transfer more than the available balance
	// Note although it's noop to transfer X chainstone to caller itself. But
