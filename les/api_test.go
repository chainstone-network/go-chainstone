...
import (
	...
	ethdownloader "github.com/chainstone-network/go-chainstone/eth/downloader"
	...
	"github.com/chainstone-network/go-chainstone/p2p/simulations"
...
func newLesServerService(ctx *adapters.ServiceContext, stack *node.Node) (node.Lifecycle, error) {
	...
	chainstone, err := eth.New(stack, &config)
	if err != nil {
		return nil, err
	}
	_, err = NewLesServer(stack, chainstone, &config)
	if err != nil {
		return nil, err
	}
	return chainstone, nil
}
