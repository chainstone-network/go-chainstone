...
// mapped from textual names used in the tests below to actual Chainstoneeum private
...
// address retrieves the Chainstoneeum address of a tester account by label, creating
...
func (ap *testerAccountPool) address(account string) common.Address {
	...
	// Resolve and return the Chainstoneeum address
...
func TestClique(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			// batch (https://github.com/chainstone-network/go-chainstone/issues/17593). Whilst this
