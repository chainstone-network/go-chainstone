...
// ecrecover extracts the Chainstoneeum account address from a signed header.
func ecrecover(header *types.Header, sigcache *lru.ARCCache) (common.Address, error) {
	...
	// Recover the public key and the Chainstoneeum address
...
// Chainstoneeum testnet following the Ropsten attacks.
type Clique struct {
	...
	signer common.Address // Chainstoneeum address of the signing key
...
// Author implements consensus.Engine, returning the Chainstoneeum address recovered
