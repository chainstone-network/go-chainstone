...
// Package ethclient provides a client for the Chainstoneeum RPC API.
package ethclient
...
// Client defines typed wrappers for the Chainstoneeum RPC API.
type Client struct {
	c *rpc.Client
}
...
func (ec *Client) getBlock(ctx context.Context, method string, args ...interface{}) (*types.Block, error) {
	...
	if err != nil {
		...
		return nil, chainstone.NotFound
	}
...
func (ec *Client) TransactionByHash(ctx context.Context, hash common.Hash) (tx *types.Transaction, isPending bool, err error) {
	...
	if err != nil {
		...
		return nil, false, chainstone.NotFound
...
func (ec *Client) SyncProgress(ctx context.Context) (*chainstone.SyncProgress, error) {
	var raw json.RawMessage
...
func (ec *Client) SubscribeNewHead(ctx context.Context, ch chan<- *types.Header) (chainstone.Subscription, error) {
...
func (ec *Client) FilterLogs(ctx context.Context, q chainstone.FilterQuery) ([]types.Log, error) {
...
func (ec *Client) SubscribeFilterLogs(ctx context.Context, q chainstone.FilterQuery, ch chan<- types.Log) (chainstone.Subscription, error) {
	arg, err := toFilterArg(q)
	if err != nil {
		return nil, err
	}
...
func toFilterArg(q chainstone.FilterQuery) (interface{}, error) {
...
func (ec *Client) CallContract(ctx context.Context, msg chainstone.CallMsg, blockNumber *big.Int) ([]byte, error) {
...
func (ec *Client) CallContractAtHash(ctx context.Context, msg chainstone.CallMsg, blockHash common.Hash) ([]byte, error) {
	var hex hexutil.Bytes
...
func (ec *Client) PendingCallContract(ctx context.Context, msg chainstone.CallMsg) ([]byte, error) {
	var hex hexutil.Bytes
...
func (ec *Client) FeeHistory(ctx context.Context, blockCount uint64, lastBlock *big.Int, rewardPercentiles []float64) (*chainstone.FeeHistory, error) {
...
func (ec *Client) EstimateGas(ctx context.Context, msg chainstone.CallMsg) (uint64, error) {
...
func toCallArg(msg chainstone.CallMsg) interface{} {
	arg := map[string]interface{}{
		"from": msg.From,
		"to":   msg.To,
	}
...
func (p *rpcProgress) toSyncProgress() *chainstone.SyncProgress {
	if p == nil {
		return nil
	}
	return &chainstone.SyncProgress{
