...
func testSyncProgress(t *testing.T, protocol uint, mode SyncMode) {
	...
	checkProgress(t, tester.downloader, "pristine", chainstone.SyncProgress{})
	...
	<-starting
	checkProgress(t, tester.downloader, "initial", chainstone.SyncProgress{
	...
	<-starting
	checkProgress(t, tester.downloader, "completing", chainstone.SyncProgress{
	...
	progress <- struct{}{}
	pending.Wait()
	checkProgress(t, tester.downloader, "final", chainstone.SyncProgress{
		StartingBlock: uint64(len(chain.blocks)/2 - 1),
...
func checkProgress(t *testing.T, d *Downloader, stage string, want chainstone.SyncProgress) {
	// Mark this method as a helper to report errors at callsite, not in here
	t.Helper()
...
func testForkedSyncProgress(t *testing.T, protocol uint, mode SyncMode) {
	...
	<-starting
	checkProgress(t, tester.downloader, "forking", chainstone.SyncProgress{
