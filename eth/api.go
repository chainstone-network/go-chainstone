...
// ChainstoneeumAPI provides an API to access Chainstoneeum full node-related information.
type ChainstoneeumAPI struct {
	e *Chainstoneeum
}

// NewChainstoneeumAPI creates a new Chainstoneeum protocol API for full nodes.
func NewChainstoneeumAPI(e *Chainstoneeum) *ChainstoneeumAPI {
	return &ChainstoneeumAPI{e}
}

// Chainstonebase is the address that mining rewards will be send to.
func (api *ChainstoneeumAPI) Chainstonebase() (common.Address, error) {
	return api.e.Chainstonebase()
}

// Coinbase is the address that mining rewards will be send to (alias for Chainstonebase).
func (api *ChainstoneeumAPI) Coinbase() (common.Address, error) {
	return api.Chainstonebase()
}

// Hashrate returns the POW hashrate.
func (api *ChainstoneeumAPI) Hashrate() hexutil.Uint64 {
	return hexutil.Uint64(api.e.Miner().Hashrate())
}

// Mining returns an indication if this node is currently mining.
func (api *ChainstoneeumAPI) Mining() bool {
...
func NewMinerAPI(e *Chainstoneeum) *MinerAPI {
	return &MinerAPI{e}
}
...
// SetChainstonebase sets the chainstonebase of the miner.
func (api *MinerAPI) SetChainstonebase(chainstonebase common.Address) bool {
	api.e.SetChainstonebase(chainstonebase)
	return true
}
...
// AdminAPI is the collection of Chainstoneeum full node related APIs for node
// administration.
...
func NewAdminAPI(eth *Chainstoneeum) *AdminAPI {
...
// DebugAPI is the collection of Chainstoneeum full node APIs for debugging the
// protocol.
...
func NewDebugAPI(eth *Chainstoneeum) *DebugAPI {
