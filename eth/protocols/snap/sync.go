...
import (
	...
	"github.com/chainstone-network/go-chainstone/p2p/msgrate"
...
// Syncer is an Chainstoneeum account and storage trie syncer based on snapshots and
...
// NewSyncer creates a new snapshot syncer to download the Chainstoneeum state over the
// snap protocol.
