...
// testBackend is a mock implementation of the live Chainstoneeum message handler. Its
...
func testGetNodeData(t *testing.T, protocol uint) {
	...
	generator := func(i int, block *core.BlockGen) {
		switch i {
		case 0:
			// In block 1, the test bank sends account #1 some chainstone.
			...
			block.AddTx(tx)
		case 1:
			// In block 2, the test bank sends some more chainstone to account #1.
