...
// Defaults contains default settings for use on the Chainstoneeum main net.
var Defaults = Config{
...
type Config struct {
	...
	// If nil, the Chainstoneeum main net block is used.
	...
	// canonical chain of all remote peers. Setting the option makes gchain verify the
	...
	// send-transaction variants. The unit is chainstone.
	RPCTxFeeCap float64
