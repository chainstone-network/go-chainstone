 ...
 * @author Gary Rong<garyrong@chainstone.org>, Martin Swende <martin.swende@chainstone.org>
...
contract CheckpointOracle {
    ...
    */
    ...
    //
    // The default value should be the same as the checkpoint size(32768) in the chainstone.
    uint sectionSize;
