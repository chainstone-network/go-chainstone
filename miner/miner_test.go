...
// TestMinerSetChainstonebase checks that chainstonebase becomes set even if mining isn't
// possible at the moment
func TestMinerSetChainstonebase(t *testing.T) {
	miner, mux, cleanup := createMiner(t)
	defer cleanup(false)
...
func createMiner(t *testing.T) (*Miner, *event.TypeMux, func(skipMiner bool)) {
	...
	config := Config{
		Chainstonebase: common.HexToAddress("123456789"),
	}
	// Create chainConfig
	memdb := memorydb.New()
