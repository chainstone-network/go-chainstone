...
// Package graphql provides a GraphQL interface to Chainstoneeum node data.
package graphql
...
// Account represents an Chainstoneeum account at a particular block.
type Account struct {
	r             *Resolver
...
// Transaction represents an Chainstoneeum transaction.
...
// Block represents an Chainstoneeum block.
...
type CallData struct {
	From                 *common.Address // The Chainstoneeum address the call is from.
	To                   *common.Address // The Chainstoneeum address the call is to.
...
type SyncState struct {
	progress chainstone.SyncProgress
}
