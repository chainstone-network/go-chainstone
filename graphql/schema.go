...
const schema string = `
    ...
    scalar Bytes32
    # Address is a 20 byte Chainstoneeum address, represented as 0x-prefixed hexadecimal.
    scalar Address
    ...
    # Account is an Chainstoneeum account at a particular block.
    type Account {
    ...
    # Log is an Chainstoneeum event log.
    type Log {
    ...
    # Transaction is an Chainstoneeum transaction.
    type Transaction {
    ...
    # Block is an Chainstoneeum block.
    type Block {
        ...
        # Account fetches an Chainstoneeum account at the current block's state.
    ...
    type Pending {
      ...
      transactions: [Transaction!]
      # Account fetches an Chainstoneeum account for the pending state.
      account(address: Address!): Account!
    ...
    type Query {
        # Block fetches an Chainstoneeum block by number or by hash. If neither is
