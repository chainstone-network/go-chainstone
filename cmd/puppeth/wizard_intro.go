...
// setting up a new or managing an existing Chainstoneeum private network.
func (w *wizard) run() {
	fmt.Println("+-----------------------------------------------------------+")
	fmt.Println("| Welcome to puppeth, your Chainstoneeum private network manager |")
	fmt.Println("|                                                           |")
	fmt.Println("| This tool lets you create a new Chainstoneeum network down to  |")
	...
	log.Info("Administering Chainstoneeum network", "name", w.network)
