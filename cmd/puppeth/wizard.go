...
type wizard struct {
	...
	services map[string][]string   // Chainstoneeum services known to be running on servers
...
// it to an Chainstoneeum address.
...
// converts it to an Chainstoneeum address. If an empty line is entered, the default
// value is returned.
