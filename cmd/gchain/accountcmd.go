...
var (
	walletCommand = &cli.Command{
		Name:      "wallet",
		Usage:     "Manage Chainstoneeum presale wallets",
		ArgsUsage: "",
		Description: `
    gchain wallet import /path/to/my/presale.wallet

will prompt for your password and imports your chainstone presale account.
		...
		Subcommands: []*cli.Command{
			{
				...
				Name:      "import",
				Usage:     "Import Chainstoneeum presale wallet",
				ArgsUsage: "<keyFile>",
				Action:    importWallet,
				Flags: []cli.Flag{
					utils.DataDirFlag,
				...
				Description: `
	gchain wallet [options] /path/to/my/presale.wallet
...
between chainstone nodes by simply copying.
...
For non-interactive use the password can be specified with the --password flag:
    ...
    gchain account update [options] <address>
...
For non-interactive use the password can be specified with the -password flag:
    ...
    gchain account import [options] <keyfile>

Note:
As you can directly copy your encrypted accounts to another chainstone instance,
...
func accountCreate(ctx *cli.Context) error {
	cfg := gchainConfig{Node: defaultNodeConfig()}
	// Load config file.
