...
var (
	...
	skipPrefixes = []string{
		...
		"crypto/secp256k1", // Relicensed to BSD-3 via https://github.com/chainstone-network/go-chainstone/pull/17225
	}
	...
	authorsFileHeader = "# This is the official list of go-chainstone authors for copyright purposes.\n\n"
)

// this template generates the license comment.
// its input is an info structure.
var licenseT = template.Must(template.New("").Parse(`
// Copyright {{.Year}} The go-chainstone Authors
...
func (i info) Whole(startOfSentence bool) string {
	if i.gpl() {
		return "go-chainstone"
	}
	if startOfSentence {
		return "The go-chainstone library"
	}
	return "the go-chainstone library"
}
