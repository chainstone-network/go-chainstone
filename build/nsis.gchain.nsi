...
# 1. install gchain for all users
# 2. install optional development tools such as abigen
# 3. create an uninstaller
# 4. configures the Windows firewall for gchain
# 5. create gchain, attach and uninstall start menu entries
# 6. configures the registry that allows Windows to manage the package through its platform tools
# 7. adds the environment system wide variable CHAINSTONE_SOCKET
...
!define GROUPNAME "Chainstoneeum"
!define APPNAME "Gchain"
!define DESCRIPTION "Official Go implementation of the Chainstoneeum protocol"
!addplugindir .\
...
function .onInit
  # make vars are global for all users since gchain is installed global
