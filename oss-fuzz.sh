...
coverpkg="github.com/chainstone-network/go-chainstone/..."
...
function compile_fuzzer {
  # Inputs:
  # $1: The package to fuzz, within go-chainstone
  # $2: The name of the fuzzing function
  # $3: The name to give to the final fuzzing-binary

  path=$GOPATH/src/github.com/chainstone-network/go-chainstone/$1
  func=$2
  fuzzer=$3
