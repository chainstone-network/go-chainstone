...
func TestIPCPathResolution(t *testing.T) {
	var tests = []struct {
		...
		{"", "", false, ""},
		{"data", "", false, ""},
		{"", "gchain.ipc", false, filepath.Join(os.TempDir(), "gchain.ipc")},
		{"data", "gchain.ipc", false, "data/gchain.ipc"},
		{"data", "./gchain.ipc", false, "./gchain.ipc"},
		{"data", "/gchain.ipc", false, "/gchain.ipc"},
		{"", "", true, ``},
		{"data", "", true, ``},
		{"", "gchain.ipc", true, `\\.\pipe\gchain.ipc`},
		{"data", "gchain.ipc", true, `\\.\pipe\gchain.ipc`},
		{"data", `\\.\pipe\gchain.ipc`, true, `\\.\pipe\gchain.ipc`},
	}
